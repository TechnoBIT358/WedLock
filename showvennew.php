	  ...
	  if(mysqli_fetch_row($si1)>0)
		{
			...
			$si1=mysqli_query($cnt,$sh1);
			 ...
			 echo'<br><br>';
			 echo'<div class="a"><font size=4><b>VENDOR ID = '.$r[0].'</font></div>';
			 echo'<div class="a"><font size=4><b>NAME = '.$r[1].'</font></div>';
			 $_SESSION['na']=$r[1];
			 echo'<div class="a"><font size=4>EMAIL= '.$r[2].'</font></div>';
			 echo'<div class="a"><font size=4>PHONE NO.= '.$r[3].'</font></div>';
			 echo'<div class="a"><font size=4>PASSWORD= '.$r[4].'</b></font></div>';
