...
<body background="d.jpeg" height="100%" width="100%">
 ...
 <div class="container-fluid" id="body1"> 
  ...
  echo'<div class="row">';
	...
	echo'<center><font size=5 color="white"><b>VENDOR INFORMATION:</b></font></center>';		 
  ...
  if($si1)                                                                                        
  {
	  ...
	  if(mysqli_fetch_row($si1)>0)
		...
		echo'<div class="row1">';
			 ...
			 echo'<div class="a">PHONE= '.$r[3].'</div>';
			 echo'<div class="a">PASSWORD= '.$r[4].'</div>';
  ...
  $si1=mysqli_query($cnt,$sh1);
			echo'<form action="adminupvennew.php" method="POST">';
	echo'<br><br><font color="white" size="4"><B>SELECT VENDOR ID</font> </B>&nbsp&nbsp&nbsp&nbsp<select name="au" id="d">';
			...
			echo'</select>';
			echo'&nbsp&nbsp&nbsp&nbsp<input type="submit" name="usp" value="UPDATE VENDOR" class="c">';
			echo'&nbsp&nbsp&nbsp&nbsp<input type="submit" name="del" value="DELETE VENDOR" class="c">';
			echo'<br></form>';
			echo'</div>';
