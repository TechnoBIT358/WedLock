...
$sv="select *from ven where id='".$ue."'";
...
if($svq)
	...
	{
	$svq=mysqli_query($cnt,$sv);
	echo'<form action="adupvennew.php" method="POST">';
			while($r=mysqli_fetch_row($svq))
			{
			echo'<div class="col-md-6 col-md-offset-3">';
			 echo'<div id="r1">';
			 echo '<br><div class="a">VENDOR ID :<input type="text" class="t" name="i"readonly value='.$r[0].'></div>';
			echo '<br><div class="a">NAME :<input type="text" class="t" name="n"readonly value='.$r[1].'></div>';
			echo '<br><div class="a">EMAIL :&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" class="t" name="v"readonly value='.$r[2].'></div>';
...
$sv="delete from ven where id='".$ue."'";
  $sv2="delete from vender where email='".$ue."'";
