...
?>
<html lang="en">
  <head><title>Vender Profile</title>
  <meta charset="utf-8">
  ...
  <nav class="navbar " style="background-color:rgba(216,10,102,1);">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-left">
        ...
        <li><a href="venpkreg.php"><font color="white">ADD SERVICE</a></font></li>
...
echo'<div class="row">';
  ...
  $sh1='select * from booking where vemail like"%'.$ve.'%"';
	  ...
	  if(mysqli_fetch_row($si1)>0)
		{
			...
			{
			echo"<font color='white'> no bookings done yet</font>";
			}
  }
