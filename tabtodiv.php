  ...
  <nav class="navbar " style="background-color:rgba(216,10,102,1);">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-left">
		...
		<li><a href="showuser.php"><font color="white">MY PROFILE</a></font></li>
        <li><a href="updateuser.php"><font color="white">EDIT PROFILE</a></font></li>
	  ...
	  if(mysqli_fetch_row($si1)>0)
		{
			...
			$si1=mysqli_query($cnt,$sh1);
			 ...
			 echo'<br><br>';
			 echo'<div class="a"><font size=4><b>CUSTOMER ID = '.$r[0].'</font></div>';
			 echo'<div class="a"><font size=4>EMAIL= '.$r[1].'</font></div>';
			 echo'<div class="a"><font size=4>PHONE NO.= '.$r[2].'</font></div>';
			 echo'<div class="a"><font size=4>PASSWORD= '.$r[3].'</b></font></div>';
